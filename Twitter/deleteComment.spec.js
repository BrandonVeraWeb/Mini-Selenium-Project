...
suite(
  function (env) {
    describe("Delete a comment test", function () {
      this.timeout(50000);
      let driver;
      ...
      it("Deleting a comment", async function () {
        ...
        await driver
          ...
          .click();
        const btnDelete = By.xpath(
          '//*[@id="layers"]/div[2]/div/div/div/div[2]/div/div[3]/div/div/div/div[1]/div[2]/div/span'
        );
        await driver.findElement(btnDelete).click();
        await driver.manage().setTimeouts({ implicit: 10000 });
        const btnConfirm = By.xpath(
          '//*[@id="layers"]/div[2]/div/div/div/div/div/div[2]/div[2]/div[2]/div[1]/div'
        );
        await driver.findElement(btnConfirm).click();
      });
